...
<div class="container">
    <!-- <div class="search-box col-md-8 mt-5 mb-0">
        <input type="text" class="form-control" id="searchBar" placeholder="Cari Poliklinik..." title="Type in a name">
    </div> -->
</div>
<div class="container valign">
    <div class="main">
        <div class="gambar">
            <img style="width:500px;" src="<?php echo base_url('img/dc3.png') ?>" alt="">
        </div>
        <div class="konten">
            <div class="search-box col-md-12 mt-5 mb-0">
                <input type="text" class="form-control" id="searchBar" placeholder="Cari Poliklinik..." title="Type in a name">
                <br>
            </div>
            <div class="col-md-12">
                <!-- buat nampilin produk nya -->
                <div class="poli-card" id="charactersList"></div>
            </div>
        </div>
    </div>
</div>
